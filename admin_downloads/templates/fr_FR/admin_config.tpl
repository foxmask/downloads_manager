...
{form $form, 'admin_downloads~mgr:config'}
    <fieldset>
        ...
        <p><span class="desc">Si oui, tout le monde pourra télécharger ; si non, seuls les membres du site le pourront.</span></p>
        ...
        <p><span class="desc">Permet d'autoriser ou non les liens directs sur les fichiers sans passer par votre site.</span></p>
    </fieldset>
    <fieldset>
        ...
        <p><span class="desc">Indiquez le nombre de téléchargements à afficher sur le module.</span></p>

        <p><span class="fakelabel">{ctrl_label 'last_downloads_on_home'}<br/>{ctrl_control 'last_downloads_on_home'}</span></p>
        <p><span class="desc">Permet d'afficher sur l'accueil du module les derniers téléchargements ajoutés.</span></p>

        <p><span class="fakelabel">{ctrl_label 'most_popular_downloads_on_home'}<br/> {ctrl_control 'most_popular_downloads_on_home'}</span></p>
        <p><span class="desc">Permet d'afficher sur l'accueil du module les téléchargements les plus populaires toutes catégories confondues.</span></p>
    </fieldset>
