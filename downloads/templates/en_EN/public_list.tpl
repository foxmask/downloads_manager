...
<table class="records-list">
	...
	<tr class="{cycle array('even','odd')}">
		<td class="downloads-colleft"><a href="{jurl 'downloads~default:view',array('url'=>$download->dl_url,'dir'=>$download->dl_path)}" title="Download details">{$download->dl_name}</a></td>        
...
{if $popular}
<div class="downloads">
	<h3><span><img src="{$j_themepath}img/pop_download.png" alt="The Populars downloads"/>The Populars downloads</span></h3>
</div>
<table class="records-list">
	<thead>
		<tr>
...
{if $lastest}
<div class="downloads">
	<h3><span><img src="{$j_themepath}img/last_download.png" alt="Last downloads"/> Latests added downloads</span></h3>
</div>		
<table class="records-list">
	<thead>
		<tr>
